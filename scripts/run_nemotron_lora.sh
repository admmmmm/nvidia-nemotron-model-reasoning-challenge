...
ORIG_ASSISTANT_TARGET_STYLE="${ASSISTANT_TARGET_STYLE-}"
...
[[ -n "$ORIG_ASSISTANT_TARGET_STYLE" ]] && ASSISTANT_TARGET_STYLE="$ORIG_ASSISTANT_TARGET_STYLE"
...
ASSISTANT_TARGET_STYLE="${ASSISTANT_TARGET_STYLE:-boxed_final_line}"
...
cmd=(
  ...
  --assistant-target-style "$ASSISTANT_TARGET_STYLE"
)
...
echo "ASSISTANT_TARGET_STYLE=$ASSISTANT_TARGET_STYLE"
